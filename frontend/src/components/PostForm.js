      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="grid gap-6 mb-6 md:grid-cols-2 p-3">
          <div>
            ...
            <input type="text" className='bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500' name="title" value={formData.title} onChange={handleChange} placeholder="An amazing song idea" required />
          </div>
          <div>
            <label htmlFor="use" className="block mb-2 text-lg font-medium text-gray-900 dark:text-white">Artist Name</label>
            <input type="text" className='bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500' name="user" value={formData.user} onChange={handleChange} placeholder="Artist Name" required />
          </div>
          <div>
            <label htmlFor="genre" className="block mb-2 text-lg font-medium text-gray-900 dark:text-white">Genre</label>
            <input type="text" className='bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500' name="genre" value={formData.genre} onChange={handleChange} placeholder="House" required />
          </div>
          <div>
            <label htmlFor="link" className="block mb-2 text-lg font-medium text-gray-900 dark:text-white">SoundCloud link</label>
            <input type="text" className='bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500' name="link" value={formData.link} onChange={handleChange} placeholder="https://on.soundcloud.com/example" required />
          ...
          <div>
            ...
            <textarea name="desc" className='block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500' value={formData.desc} onChange={handleChange} placeholder="A short description for your post..." required />
          </div>
          <div>
            <label htmlFor="like" className="block mb-2 text-lg font-medium text-gray-900 dark:text-white">Likes</label>
            <input type="number" className='bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500' name="like" value={formData.like} onChange={handleChange} placeholder="Likes" required />
          </div>
        </div>
        <div className='flex flex-col'>
          <button class="self-center relative inline-flex items-center justify-center p-0.5 mb-2 me-2 overflow-hidden text-sm font-medium text-gray-900 rounded-lg group bg-gradient-to-br from-purple-600 to-blue-500 group-hover:from-purple-600 group-hover:to-blue-500 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800" >
