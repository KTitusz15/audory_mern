...
<div class="sm:hidden fixed z-50 w-11/12 h-16 max-w-lg -translate-x-1/2 bottom-4 left-1/2 bg-black shadow-[0px_0px_10px_0px_#1e1b4b] rounded-2xl bg-clip-padding backdrop-filter backdrop-blur-3xl bg-opacity-10 border border-gray-700">
